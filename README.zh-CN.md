...
<div align="center">
  <img src="assets/model-win-rate.svg" alt="模型观察表现：Claude 胜率 90%、净收益 +30%；Gemini 胜率 75%、净收益 +75%" width="100%">
</div>

| 模型 | 观察方向胜率 | 观察净收益 | 当前状态 |
|---|---:|---:|---|
| **Claude** | **90%** | **+30%** | 当前 Claude 兼容决策链路 |
| **Gemini** | **75%** | **+75%** | 对比观察数据；此版本未内置 Gemini 适配器 |
